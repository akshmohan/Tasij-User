...
import '../../../controllers/video_shopping_details_controller.dart';
...
class DetailsVideoShopping extends StatelessWidget {
  ...
  final VideoShoppingDetailsController videoShoppingDetailsController =
      Get.put(VideoShoppingDetailsController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SizedBox(
          height: size.height,
          width: size.width,
          child: Obx(() => videoShoppingDetailsController.isLoader.value
              ? const Center(child: ShimmerVideoShopping())
              : detailsUi(
                  videoShoppingDetailsController
                      .videoShoppingDetailsModel.value,
                  context))),
    );
  }

  Widget detailsUi(
      VideoShoppingDetailsModel videoShoppingDetailsModel, context) {
    return ListView(
      children: [
        ...
        videoShoppingDetailsModel.data!.video!.videoType == "mp4"
            ? videoShoppingDetailsController
                ...
                ? Stack(
                    ...
                    children: [
                      AspectRatio(
                        aspectRatio: videoShoppingDetailsController
                            .videoPlayerController!.value.aspectRatio,
                        child: Chewie(
                          controller:
                              videoShoppingDetailsController.chewieController!,
                        ),
                      ),
                      backButton(context),
                    ],
            ...
            ? Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(AppTags.recommendedProducts.tr,
                  ...
                  videoShoppingDetailsController.productStyle()
                      ? ListView.builder(
                          ...
                          itemCount: videoShoppingDetailsModel
                              .data!.video!.products!.length,
                            ...
                            return InkWell(
                                onTap: () {
                                  Get.toNamed(
                                    Routes.detailsPage,
                                    parameters: {
                                      'productId': videoShoppingDetailsModel
                                          .data!.video!.products![index].id!
                                          .toString(),
                                    },
                                  );
                                },
                                child: VideoProductVerticalCard(
                                    dataModel: videoShoppingDetailsModel
                                        .data!.video!.products,
                                    index: index));
                          })
                      : SizedBox(
        ...
        videoShoppingDetailsModel.data!.video!.relatedProducts!.isNotEmpty
            ? Column(
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 15.w),
                    child: Text(AppTags.relatedProducts.tr,
                        style: isMobile(context)
                            ? AppThemeData.headerTextStyle_16
                            : AppThemeData.headerTextStyle_16
                                .copyWith(fontSize: 13.sp)),
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      padding: EdgeInsets.symmetric(horizontal: 15.w),
                      itemCount: videoShoppingDetailsModel
                          .data!.video!.relatedProducts!.length,
                      scrollDirection: Axis.horizontal,
                      physics: const BouncingScrollPhysics(),
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              Get.toNamed(
                                ...
                                parameters: {
                                  'productId': videoShoppingDetailsModel
                                      .data!.video!.relatedProducts![index].id!
                                      .toString(),
                                },
                              );
                            },
        ...
        videoShoppingDetailsModel.data!.video!.popularVideos!.isNotEmpty
            ? Column(
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 15.w),
                    child: Text(AppTags.popularVideo.tr,
                        style: isMobile(context)
                            ? AppThemeData.headerTextStyle_16
                            : AppThemeData.headerTextStyle_16
                                .copyWith(fontSize: 13.sp)),
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: videoShoppingDetailsModel
                          .data!.video!.popularVideos!.length,
                      scrollDirection: Axis.horizontal,
                      physics: const BouncingScrollPhysics(),
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () {
                            videoShoppingDetailsController.videoShoppingDetail(
                                videoShoppingDetailsModel
                                    .data!.video!.popularVideos![index].slug
                                    .toString());
                          },
                          child: Padding(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    right: 3.w,
                                    child: Text(
                                      videoShoppingDetailsModel.data!.video!
  ...
  Widget backButton(context) => Padding(
        padding: EdgeInsets.symmetric(
            horizontal: isMobile(context) ? 6.w : 3.w,
            vertical: isMobile(context) ? 6.h : 3.h),
        child: InkWell(
          onTap: () {
            Get.back();
          },
          child: Container(
            ...
            child: Padding(
              ...
              child: SvgPicture.asset(
                "assets/icons/video_back_button.svg",
              ),
            ),
          ),
        ),
