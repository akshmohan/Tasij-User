...
class _EditProfileState extends State<EditProfile> {
  ...
  void updateProfile() {
    ...
    final updatedUserData = {
      ...
      'gender': selectGender != null
          ? selectGender.toString()
          : widget.userDataModel.data!.gender.toString(),
      'date_of_birth': formetedDate != null
          ? formetedDate!.toString()
          : widget.userDataModel.data!.dateOfBirth.toString(),
    };
    ...
    if (selectedImage != null) {
      Repository()
        ...
        image: selectedImage!,
          ...
          .then((value) {
        _handleUpdateResponse(value, updatedUserData);
      });
    }
    // Without image
    else {
  ...
  void _handleUpdateResponse(
      UserDataModel? value, Map<String, String> updatedUserData) {
    log(value.toString(), name: "jhu");
    if (value != null) {
      // Update the userDataModel to reflect the new data
      setState(() {
        widget.userDataModel.data!.firstName = updatedUserData['first_name']!;
        widget.userDataModel.data!.lastName = updatedUserData['last_name']!;
        widget.userDataModel.data!.email = updatedUserData['email']!;
        widget.userDataModel.data!.phone = updatedUserData['phone']!;
        widget.userDataModel.data!.gender = updatedUserData['gender']!;
        widget.userDataModel.data!.dateOfBirth =
